		...
		<div class="container_inner clearfix">
			<div class="container_inner2 clearfix">
				...
				<div class="content_width_75">
					<p class="intro_text_green">In this blog, we publish articles and stories we believe people will find useful in the areas of criminal defense and justice, OVI / DUI and other issues we think our visitors will find useful. If you have any tips or topics you would like us to write about, please feel free to suggest article topics by email us at <a href="mailto:advice@cincinnaticriminalattorney.com" title="Email us today">advice@cincinnaticriminalattorney.com.</a></p>
				</div>
									...
									<article <?php if ( !has_post_thumbnail() ) { echo "class='no_image'"; } ?>>
										<?php if ( has_post_thumbnail() ) { ?>
											<div class="post_image">
												...
												<span class="create_date"><?php the_time('F jS, Y'); ?></span>	
										...
										<div class="post_text_holder">
											<div class="post_text_inner">
												...
												<span class="create">
													Categories: <span class="category"><?php the_category(', '); ?></span>
												</span>
												<?php the_excerpt(); ?>

												<a href="<?php the_permalink(); ?>" class="read_more" title="<?php the_title_attribute(); ?>">Read More</a>
											</div>
										</div>	
									</article>
								<?php endwhile; ?>
